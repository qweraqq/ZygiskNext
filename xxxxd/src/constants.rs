...
pub const PATH_CP_BIN32: &str = "bin/xxxx-cp32";
pub const PATH_CP_BIN64: &str = "bin/xxxx-cp64";
pub const PATH_PT_BIN32: &str = "bin/xxxx-ptracer32";
pub const PATH_PT_BIN64: &str = "bin/xxxx-ptracer64";
